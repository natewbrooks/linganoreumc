...
export default function Filter({ filter, setFilter, filterOptions }) {
	return (
		<div className={`transition flex text-sm w-full bg-bkg-tp py-1 skew-l`}>
			<div className={`flex space-x-4 skew-r px-4 font-dm`}>
				...
				<div className={`flex space-x-1`}>
					{filterOptions.map((option) => (
						<div
							...
							className={`clickable-l-skew transition ${
