...
function Events() {
	...
	const { featured, upcoming, previous } = useMemo(() => {
		...
		events.forEach((event) => {
			...
			// Add featured regardless of search
			if (event.isFeatured) {
				featured.push(event);
			}
	...
	return (
		<div className='flex flex-col my-8'>
			<div className={`flex flex-col space-y-8 `}>
				<div className={`flex flex-col items-center w-full  page-l-wrapper px-4 py-4 md:py-10`}>
					<div className={`flex flex-col w-full space-y-4 items-start justify-start`}>
