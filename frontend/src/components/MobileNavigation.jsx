...
function MobileNavigation() {
	...
	return (
		<div className={`w-full`}>
			<div
				className={`w-full flex items-center justify-between px-4 bg-red border-b-4 border-bkg h-[80px]`}>
				<Link to={`/`}>
					<Logo
						width={250}
						className={`group-hover:opacity-50 h-full`}
					/>
				</Link>
				<div
					onClick={() => {
					...
					className={`flex flex-col justify-center items-center space-y-2 h-[30px] w-[30px]`}>
					<div
						className={`${
